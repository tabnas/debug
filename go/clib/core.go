...
//
// libtabnasdebug is the debug format parser as a C shared library, one of
...
// newParser builds one engine with the debug grammar installed
...
// parseWith answers whether src is in the debug language — and,
