...
repository: layout, the TypeScript-canonical / Go-and-Rust-port contract,
the `model()` structured contract other repos assert against, the dual Go
engine resolutions (pinned vs sibling), build & test commands, and how
